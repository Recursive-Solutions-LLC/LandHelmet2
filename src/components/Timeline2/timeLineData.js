...
const timeLineData = [
    {
        id: uuidv4(),
        year: 1,
        icon: <img src={r1} alt='hand modeling'/>,
        heading: 'Hand Modeling',
        text: 'We start with hand modeling, creating a physical prototype of your helmet concept.This initial model is crucial for visualizing the basic shape',
        transform: '',
    },

    {
        ...
        text: 'The hand model undergoes CNC 3D scanning, resulting in detailed digital drawings.These drawings provide a precise base for further development',
