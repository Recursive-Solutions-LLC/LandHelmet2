                ...
                <div className="row align-center">
                    ...
                    <div className=" col-12">
                        <div className="block-contents ml-40">
                            ...
                            <p>We understand that the safety market is constantly changing  and evolving, that maintaining a competitive edge both within the industry and supporting our customers effectiveness requires significant investment in expanding capabilities, resources and research and development activities. We have a clear and focused research, development and investment strategy based on a blend of qualities such as ambition, drive and commitment as well as more tangible assets such as specialist engineering skills, maximising modern and emerging technologies, rapid development through simulation techniques, electronics expertise and a ruthless quest for performance and reliability in our products. <strong>Turn your vision into premium protection. </strong>  </p>
