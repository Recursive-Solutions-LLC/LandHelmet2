...
const portfolioTwoData = [
  ...
  {
    id: uuidv4(),
      image: img1, cost: "/contact",

    heading: "Effortless  Direct Communication",
    name: "We prioritize world-class customer care project management for exceptional service. With a focus on direct access, our team of technical experts emerges as your dedicated creative problem solvers, cutting out middlemen for streamlined solutions. Experience unparalleled satisfaction with our customer-centric approach.",
  },
...

  {
    ...
    name: "From mold opening to final product assembly, our integrated manufacturing facilities offer a comprehensive one-stop solution. With a steadfast focus on cost reduction and productivity enhancement, we ensure efficiency at every step of the process.",
  },
  {
    id: uuidv4(),
      image: img5, cost: "/contact",

    heading: "Cost Optimization",
    name: "From Development to Installation.Experience seamless process development, documentation, and manufacturing line setup within a lean framework. Clear communication and quality management are key when working with us. Our team ensures ongoing quality control, minimizing costs and maximizing performance.",
  },
  {
    id: uuidv4(),
      image: img6, cost: "/contact",
